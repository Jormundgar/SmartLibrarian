...
async function getLines() {
    lines = await $.ajax({
        url: "http://localhost:8070/api/books/number",
        method: "GET",
        dataType: 'json'
    });
}
...
async function getId(id, type) {
    let json = await $.ajax({
        url: `http://localhost:8070/api/books/item?id=${id}`,
        method: 'GET',
        dataType: 'json'
    });
    if (type === 'delete') {
...
async function showAssignModal(book) {
    ...
    const readers = await $.ajax({
        url: 'http://localhost:8070/api/readers',
        method: 'GET',
        dataType: 'json'
    });
...
async function assignBook(){
    ...
    await $.ajax({
        url: `http://localhost:8070/api/books/assign`,
        method: 'PATCH',
...
async function releaseBook() {
    ...
    await $.ajax({
        url: `http://localhost:8070/api/books/release?id=${id}`,
        method: 'PATCH',
        success: function () {
            getBooks();
        }
...
async function deleteBook() {
    ...
    await $.ajax({
        url: `http://localhost:8070/api/books?id=${id}`,
        method: 'DELETE',
        success: function () {
            getBooks();
        }
...
async function getBooks() {
    ...
    let bookJson = await $.ajax({
        url: `http://localhost:8070/api/books?byYear=${byYear}&pageNumber=${page}`,
        method: "GET",
        dataType: 'json'
    });
    booksTBody.empty();
