package com.volkov.backend.controllers.api;

import com.volkov.backend.dto.BookDTO;
import com.volkov.backend.dto.ErrorDTO;
...
public interface BookRestApi {
    ...
    @Operation(
            summary = "Get number of books",
            description = "Get number of records of books in the database",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
